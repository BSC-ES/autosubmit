...
* LOG_RECOVERY_QUEUE_SIZE: A memory-consumption optimization for the recovery of logs. If not specified, defaults to min(100,TOTAL_JOBS) * 2, in case of issues with the recovery of logs, you can increase this value.
