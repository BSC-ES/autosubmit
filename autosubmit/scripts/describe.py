...
Shows details about experiments.
...
def args_parser() -> ArgumentParser:
    ...
    parser.add_argument(
        "-u",
        "--user",
        help="username; defaults to the current user or the user associated with the expid",
        default="",
    )
...
@cli_function(
    args_parser=args_parser, options_type=DescribeOptions, validators=validate_expid
)
