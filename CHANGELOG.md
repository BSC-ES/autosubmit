...
- Fixed the infinite loop generated by point a dynamic variable at itself by raising an error and allowing use of the "PATTERN=%YYYY%MM%DD" without substitution of the variables #2602 #1288
