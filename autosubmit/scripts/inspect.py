...
def args_parser() -> ArgumentParser:
    ...
    parser.add_argument("-f", "--force", action="store_true", help="Overwrite all cmd")
    parser.add_argument(
        "-cw",
        "--check_wrapper",
        action="store_true",
    ...
    parser.add_argument(
        ...
        "--quick",
        action="store_true",
        help="Only checks one job per each section",
    )
...
@cli_function(
    args_parser=args_parser, options_type=InspectOptions, validators=validate_expid
)
