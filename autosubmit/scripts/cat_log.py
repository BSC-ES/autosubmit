...
examples:
    ...
    $ autosubmit cat-log a000_20220401_fc0_1_GSV

    # show the error log of a workflow.
    $ autosubmit cat-log --file e a000

    # follow the output log as it grows.
    $ autosubmit cat-log --mode t a000
"""
...
class CatlogOptions(DefaultOptions):
...
@cli_function(
    args_parser=args_parser, group=CommandGroup.WORKFLOW, options_type=CatlogOptions
)
