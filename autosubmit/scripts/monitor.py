...
def args_parser() -> ArgumentParser:
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="Hide the groups from the plot.",
    )
    parser.add_argument(
        "-cw",
        "--check_wrapper",
        action="store_true",
        default=False,
        help="Generate wrappers in the current workflow.",
    )
    ...
    group2.add_argument(
        ...
        action="store_true",
        default=False,
        help="Generate only txt status file.",
    )
    ...
    group2.add_argument(
        ...
        action="store_true",
        default=False,
        help="Generate only text status file (AS < 3.12b behaviour).",
    )
