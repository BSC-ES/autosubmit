...
class TestPerformanceMetricsNaive:
    ...
    def test_check_and_compute_performance_metrics(self, mocker, naive_job: Job, sim_performance_with_mail_notifier: SIMPerformance, mock_smtp, utils: Utils):
        ...
        expected_sypd = sim_performance_with_mail_notifier.compute_sypd_from_job(naive_job)
        expected_threshold = sim_performance_with_mail_notifier.SYPD_THRESHOLD
        expected_under_performance = utils.get_under_performance(expected_sypd, expected_threshold)
        ...
        mock_notify_custom_alert = mocker.patch.object(
            sim_performance_with_mail_notifier._mail_notifier,
            'notify_custom_alert'
        )

        sim_performance_with_mail_notifier.compute_and_check_performance_metrics(naive_job)
