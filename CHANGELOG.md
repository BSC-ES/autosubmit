...
- Fixed issue overwrittin expid config variables with the ones from the github repo #2877
- Fix inspect infinite loop when PLATFORMS.TOTALJOBS or PLATFORMS.MAX_WAITING_JOBS is set to 0 #2749
