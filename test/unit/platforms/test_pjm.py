...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            "",
            "x11",
            " cd dummy-expid/LOG_dummy-expid ; pjsub --no-check-directory script_test_1.cmd ",
        ),
        (
            "script_test_1.cmd",
            "-o stdout.cmd",
            "x11",
            " cd dummy-expid/LOG_dummy-expid ; pjsub --no-check-directory script_test_1.cmd -o stdout.cmd",
        ),
        (
            "script_test_1.cmd",
            "",
        ...
        (
            ...
            "-e stderr.cmd",
            "",
            " cd dummy-expid/LOG_dummy-expid ; pjsub --no-check-directory script_test_1.cmd -e stderr.cmd",
        ),
    ],
)
