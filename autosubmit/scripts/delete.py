...
class DeleteOptions(AutosubmitOptions):
    ...
    # NOTE: This duplicates work from ``DefaultOptions`` -- the code is used
    #       internally only, so we are not too concerned about OOP to the
    #       point to think about multiple-inheritance, traits, etc.
