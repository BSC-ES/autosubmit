...
- Replaced redundant `list(dict.keys())` and `.keys()` patterns with direct dictionary iteration and membership checks, and replaced `print` statements with `Log.warning` calls in `job_list.py` #2477 #2372
