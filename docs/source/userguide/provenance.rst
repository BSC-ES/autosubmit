...
Users can generate an :ref:`Using RO-Crate when running experiments <RO-Crate when 
running an experiment>` by providing an ROCRATE configuration value, creating a structured metadata 
