...
- Now Autosubmit supports the 'Parsl' wrapping method, relying on the Parsl library installed on the HPC to manage wrapped tasks [#2697](https://github.com/BSC-ES/autosubmit/issues/2697)
