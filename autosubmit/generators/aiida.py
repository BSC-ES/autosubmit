...
class Generator(AbstractGenerator):
    ...
    * workgraph_submission: Submission of the AiiDA-WorkGraph
    ...
    def generate(cls, job_list: JobList, as_conf: AutosubmitConfig, output_dir: str) -> None:
        # TODO Questions:
        # - Are in autosubmit the scripts always on the local machine and then copied over to remote? what is with EXECUTABLE?
...
wg.run()""" #TODO change to submit once debugging finished
