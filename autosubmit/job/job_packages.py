...
class JobPackageHybrid(JobPackageThread):
    ...
    def __init__(self, jobs: list[list], num_processors, total_wallclock, dependency=None, jobs_resources=None, method="ASThread", configuration=None, wrapper_section="WRAPPERS"):
        if jobs_resources is None:
            jobs_resources = {}
