...
# Set .svg output for the graphs generated by GraphViz
...
author = 'Barcelona Supercomputing Center (BSC-CNS) - Earth Sciences Department'
...
# The language for content autogenerated by Sphinx. Refer to the documentation
...
htmlhelp_basename = 'autosubmitdoc'
...
man_pages = [
    (master_doc, 'autosubmit', 'autosubmit Documentation',
     [author], 1)
]
