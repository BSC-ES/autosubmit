...
@pytest.fixture
def exp_logs_dir(autosubmit_config):
    as_conf = autosubmit_config(_EXPID, {})
    exp_path = as_conf.basic_config.LOCAL_ROOT_DIR / _EXPID
...
@pytest.fixture
def aslogs_dir(autosubmit_config):
    as_conf = autosubmit_config(_EXPID, {})
    exp_path = as_conf.basic_config.LOCAL_ROOT_DIR / _EXPID
    exp_tmp_dir = exp_path / as_conf.basic_config.LOCAL_TMP_DIR
...
@pytest.fixture
def status_path(autosubmit_config):
    as_conf = autosubmit_config(_EXPID, {})
    exp_path = as_conf.basic_config.LOCAL_ROOT_DIR / _EXPID
