...
Configures the database settings and configuration paths for Autosubmit.
...
def args_parser() -> ArgumentParser:
    ...
    parser.add_argument(
        ...
        "--platformsconfpath",
        default=None,
        help="path to platforms.yml file to use by default. Optional",
    )
    parser.add_argument(
        "-jc",
        "--jobsconfpath",
        default=None,
        help="path to jobs.yml file to use by default. Optional",
    )
    parser.add_argument(
