...
class JobList(object):
    ...
    def get_packages_persistence(self, reset=False) -> JobPackagePersistence:
    ...
    def generate(self, as_conf, date_list, member_list, num_chunks, chunk_ini, parameters,
        ...
        if create:
            ...
            self.get_packages_persistence(reset=True)
    ...
    def save_wrappers(
        ...
        if wrappers:
            self.get_packages_persistence().save(wrappers, preview=inspect)
